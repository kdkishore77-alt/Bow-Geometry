...
Framework".
he code implements a physics-based model of three bow architectures — self-bow, composite recurve, and asymmetric Japanese Yumi — including bow geometry, force–draw relations, energy storage, efficiency, arrow launch velocity, and sensitivity analyses.
